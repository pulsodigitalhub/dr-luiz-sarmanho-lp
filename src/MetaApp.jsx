...
const WHATSAPP_URL = "https://api.whatsapp.com/send?phone=556135518009&text=Ol%C3%A1%2C%20gostaria%20de%20agendar%20uma%20avalia%C3%A7%C3%A3o%20com%20o%20Dr.%20Luiz%20Sarmanho.";
...
const pageMarkup = `<header class="topbar">
    <div class="container nav">
      ...
      <a class="button primary" href="${WHATSAPP_URL}">
  ...
  <main id="inicio">
    ...
    <section id="contato" class="cta-band">
      <div class="container cta-row">
        ...
        <div class="cta-card">
          <p>Toque no botão abaixo para falar direto no WhatsApp e alinhar horários, convênio e orientações iniciais.</p>
          <a class="button primary" href="${WHATSAPP_URL}">
            <img src="../assets/icons/health-line/phone.svg" alt="" aria-hidden="true">
            Falar no WhatsApp
          </a>
    ...
    <section id="convenios">
      <div class="container insurance-wrap">
        <div class="insurance-panel">
          ...
          <a class="button dark" href="${WHATSAPP_URL}">
